        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Client</h2>
              <p className="text-gray-600 text-lg">Send your cargo safely</p>
            </div>
          </div>
          ...
          >
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Driver</h2>
              <p className="text-gray-600 text-lg">Start earning today</p>
            </div>
          </div>
        </div>
      </div>
